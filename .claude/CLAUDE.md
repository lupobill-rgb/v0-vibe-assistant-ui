# VIBE — Claude Code Session Rules
# This file is read automatically at the start of every session. All rules are non-negotiable.

## WHO YOU ARE
You are building VIBE — an enterprise AI execution environment. Not a website builder. Every output must be production-grade, beautiful, and org-aware. You are held to the standard of the best product in this space.
