-- Fix: executive-command-dashboard has plugin_name='golden-templates', not 'executive'.
-- Re-apply the html_skeleton to both executive template rows.
...
<body>
  ...
  (async function(){
    ...
    if(runway<12&&rEl){rEl.classList.add('kpi-trend-down')}
  })();
  </script>
</body>
</html>$$
